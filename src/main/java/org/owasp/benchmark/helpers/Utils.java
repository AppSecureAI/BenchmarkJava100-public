...
public class Utils {
    ...
    public static SSLConnectionSocketFactory getSSLFactory() throws Exception {
        ...
        // Only allow modern TLS protocol versions, and enforce default certificate/hostname
        // verification (no self-signed trust, no hostname verification bypass)
        SSLConnectionSocketFactory sslsf =
                new SSLConnectionSocketFactory(sslcontext, new String[] {"TLSv1.2", "TLSv1.3"}, null, null);
        return sslsf;
    }
